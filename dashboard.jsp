...
try{
    ...
    PreparedStatement ps1 = con.prepareStatement(
        "SELECT * FROM health_data WHERE user_id=? ORDER BY health_id DESC LIMIT 1");
    ps1.setInt(1, userId);
    ...
    PreparedStatement ps2 = con.prepareStatement(
        "SELECT diet_type FROM diet WHERE user_id=? ORDER BY diet_id DESC LIMIT 1");
    ps2.setInt(1, userId);
    ...
    PreparedStatement ps3 = con.prepareStatement(
        "SELECT steps FROM fitness WHERE user_id=? ORDER BY fitness_id DESC LIMIT 1");
    ps3.setInt(1, userId);
